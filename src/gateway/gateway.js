...
var MyGateway = function () {
    ...
    var _onNewMessage_decorators;
    var MyGateway = _classThis = /** @class */ (function () {
        function MyGateway_1(sequelize) {
        ...
        MyGateway_1.prototype.onModuleInit = function () {
            this.server.on('connection', function (socket) {
                console.log(socket.id, ' connected');
            });
        };
        MyGateway_1.prototype.onNewMessage = function (body) {
            return __awaiter(this, void 0, void 0, function () {
                var set_chat_sql, sql, _a, chats, m1;
    ...
    __setFunctionName(_classThis, "MyGateway");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _server_decorators = [(0, websockets_1.WebSocketServer)()];
        _onNewMessage_decorators = [(0, websockets_1.SubscribeMessage)('newMessage')];
        __esDecorate(_classThis, null, _onNewMessage_decorators, { kind: "method", name: "onNewMessage", static: false, private: false, access: { has: function (obj) { return "onNewMessage" in obj; }, get: function (obj) { return obj.onNewMessage; } }, metadata: _metadata }, null, _instanceExtraInitializers);
        ...
        MyGateway = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return MyGateway = _classThis;
}();
