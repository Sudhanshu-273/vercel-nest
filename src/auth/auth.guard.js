...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(jwtService, sequelize) {
            this.jwtService = jwtService;
            this.sequelize = sequelize;
        }
        AuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var req, token, check_token_sql, _a, token_status, m2, payload, err_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            req = context.switchToHttp().getRequest();
                            token = this.extractTokenFromHeader(req);
                            check_token_sql = "select *\n                                         from tokens\n                                         where access_token = :access_token";
                            return [4 /*yield*/, this.sequelize.query(check_token_sql, {
                                    replacements: {
                                        access_token: token
                                    },
                                })];
                        case 1:
                            _a = _b.sent(), token_status = _a[0][0], m2 = _a[1];
